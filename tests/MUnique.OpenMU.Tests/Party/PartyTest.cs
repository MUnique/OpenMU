...
public class PartyTest
{
    ...
    public async ValueTask PartyMemberKickFailByNonMasterAsync()
    {
        ...
        await this._kickAction.KickPlayerAsync(partyMember2, party.PartyList.IndexOfMember(partyMember3)).ConfigureAwait(false);
    ...
    public async ValueTask PartyMemberKickHimselfAsync()
    {
        ...
        await this._kickAction.KickPlayerAsync((Player)partyMember2, party.PartyList.IndexOfMember(partyMember2)).ConfigureAwait(false);
    ...
    public async ValueTask PartyMemberKickByMasterAsync()
    {
        ...
        await this._kickAction.KickPlayerAsync(partyMaster, party.PartyList.IndexOfMember(partyMember)).ConfigureAwait(false);
    ...
    public async ValueTask PartyMasterKicksHimselfAsync()
    {
        ...
        await this._kickAction.KickPlayerAsync((Player)partyMaster, party.PartyList.IndexOfMember(partyMaster)).ConfigureAwait(false);
