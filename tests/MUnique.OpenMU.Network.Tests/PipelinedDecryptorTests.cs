...
public class PipelinedDecryptorTests
{
    ...
    [Test]
    public async Task C1DecryptAsync()
    {
        ...
        await this.DecryptAsync(packet, expected).ConfigureAwait(false);
    }
    ...
    /// <returns>The task.</returns>
    [Test]
    public async Task C2DecryptAsync()
    {
    ...
    /// <returns>The task.</returns>
    [Test]
    public async Task C3DecryptAsync()
    {
        ...
        await this.DecryptAsync(encryptedPacket, decryptedPacket).ConfigureAwait(false);
    }
    ...
    /// <returns>The task.</returns>
    [Test]
    public async Task C4DecryptAsync()
    {
    ...
    [Test]
    public async Task C3DecryptWithNonMaximalFinalBlockSizeAsync()
    {
        ...
        await this.DecryptAsync(encrypted, decrypted).ConfigureAwait(false);
    }
    ...
    /// <returns>The task.</returns>
    [Test]
    public async Task DecryptVersion075LoginPacketAsync()
    {
    ...
    /// <returns>The task.</returns>
    [Test]
    public async Task CompletesWithLastReadAsync()
    {
        var pipe = new Pipe();
    ...
    /// <returns>The task.</returns>
    [Test]
    public async Task CompletesAfterReadAsyncIsCalledAsync()
    {
        var pipe = new Pipe();
        var decryptor = new PipelinedDecryptor(pipe.Reader);
    ...
    /// <returns>The task.</returns>
    private async Task DecryptAsync(byte[] encryptedPacket, byte[] decryptedPacket)
    {
        var pipe = new Pipe();
        var decryptor = new PipelinedDecryptor(pipe.Reader);
