...
## 🎉 Current Progress: 12/94 tasks = 12.8%
...
- Low: 3/36 done (8%) - PERS-15 ✅, ITEM-11 ✅, PERS-11 ✅
...
**Priority:** 🟢 Low
**Difficulty:** ⭐ Easy
**File:** `src/Persistence/EntityFramework/CachingEntityFrameworkContext.cs:16`
**Time:** 1 hour

**Issue:** Class doesn't add logic beyond EntityFrameworkContext

**Action:**
1. Review if class is still needed
2. Check for usages
3. Remove or document purpose

**Tell me:** `"Do task PERS-9"`
...
**Priority:** 🟢 Low
**Difficulty:** ⭐ Easy
**File:** `src/Persistence/IMigratableDatabaseContextProvider.cs:10`
**Time:** 30 minutes

**Issue:** Interface name is unclear
...
2. Add to game config
3. Make adjustable

**Tell me:** `"Do task GL-11"`

---

### GL-12: Riding State Unclear 🟢
**Status:** ❌ TODO
**Priority:** 🟢 Low
**Difficulty:** ⭐ Easy
...
**Issue:** Set this state comment, unclear what's needed

**Action:**
1. Review riding state logic
2. Set state properly or remove TODO
3. Test mounting/dismounting

**Tell me:** `"Do task GL-12"`
...
**Action:**
1. Research property in MU protocol
2. Document purpose
3. Remove if not needed

**Tell me:** `"Do task MISC-2"`
...
2. Return in ToString
3. Update UI

**Tell me:** `"Do task MISC-9"`
