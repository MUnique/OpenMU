...
public readonly ref struct ChangeTerrainAttributes
{
    ...
    /// Calculates the size of the packet for the specified count of <see cref="TerrainArea"/>.
    /// </summary>
    /// <param name="areaCount">The count of <see cref="TerrainArea"/> from which the size will be calculated.</param>

    public static int GetRequiredSize(int areaCount) => areaCount * TerrainArea.Length + 7;

    /// <summary>
    /// Contains the data of one terrain area.
    /// </summary>
    public readonly ref struct TerrainArea
    {
        private readonly Span<byte> _data;
