...
/// </summary>
[PlugIn]
[Display(Name = "FriendStateUpdatePlugIn", Description = "The default implementation of the IFriendStateUpdatePlugIn which is forwarding everything to the game client with specific data packets.")]
