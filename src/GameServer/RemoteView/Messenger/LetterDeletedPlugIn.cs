...
/// </summary>
[PlugIn]
[Display(Name = "LetterDeletedPlugIn", Description = "The default implementation of the ILetterDeletedPlugIn which is forwarding everything to the game client with specific data packets.")]
