...
/// </summary>
[PlugIn]
[Display(Name = nameof(ShowLetterExtendedPlugIn), Description = "The extended implementation of the IShowLetterPlugIn which is forwarding everything to the game client with specific data packets.")]
