...
/// </summary>
[PlugIn]
[Display(Name = "SetTradeMoneyPlugIn", Description = "The default implementation of the ISetTradeMoneyPlugIn which is forwarding everything to the game client with specific data packets.")]
