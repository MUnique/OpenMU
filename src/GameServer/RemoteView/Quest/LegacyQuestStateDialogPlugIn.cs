...
/// </summary>
[PlugIn]
[Display(Name = "Quest - Status Dialog", Description = "The default implementation of the ILegacyQuestStateDialogPlugIn which is forwarding everything to the game client with specific data packets.")]
