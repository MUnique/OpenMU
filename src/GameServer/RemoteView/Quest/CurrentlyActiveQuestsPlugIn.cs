...
/// </summary>
[PlugIn]
[Display(Name = "Quest - Currently Active Quests", Description = "The default implementation of the ICurrentlyActiveQuestsPlugIn which is forwarding everything to the game client with specific data packets.")]
