...
/// </summary>
[PlugIn]
[Display(Name = nameof(QuestProgressPlugIn), Description = "The default implementation of the IQuestProgressPlugIn which is forwarding everything to the game client with specific data packets.")]
