...
/// </summary>
[PlugIn]
[Display(Name = "UpdateMasterStatsPlugIn", Description = "The default implementation of the IUpdateMasterStatsPlugIn which is forwarding everything to the game client with specific data packets.")]
