...
/// </remarks>
[PlugIn]
[Display(Name = nameof(SkillListViewPlugIn095), Description = "The implementation of the ISkillListViewPlugIn for version 0.95 which is forwarding everything to the game client with specific data packets.")]
