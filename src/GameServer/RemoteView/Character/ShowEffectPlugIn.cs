...
/// </summary>
[PlugIn]
[Display(Name = "ShowEffectPlugIn", Description = "The default implementation of the IShowEffectPlugIn which is forwarding everything to the game client with specific data packets.")]
