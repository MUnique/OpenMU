...
/// </summary>
[PlugIn]
[Display(Name = "ShowCharacterListPlugIn", Description = "The default implementation of the IShowCharacterListPlugIn which is forwarding everything to the game client with specific data packets.")]
