...
/// </summary>
[PlugIn]
[Display(Name = nameof(UpdateStatsExtendedPlugIn), Description = "The extended implementation of the IUpdateStatsPlugIn which is forwarding everything to the game client with specific data packets.")]
