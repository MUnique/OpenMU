...
/// </summary>
[PlugIn]
[Display(Name = nameof(UpdatePartyListPlugIn), Description = "The default implementation of the IUpdatePartyListPlugIn which is forwarding everything to the game client with specific data packets.")]
