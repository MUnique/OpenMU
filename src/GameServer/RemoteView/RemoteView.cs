...
namespace MUnique.OpenMU.GameServer.RemoteView
{
    ...
    public class RemoteView : ChatView, IPlayerView
    {
        ...
        public void ShowHit(IAttackable target, HitInfo hitInfo)
        {
            ...
            this.connection.Send(new byte[]
            {
                0xC1, 0x0A, (byte)PacketType.Hit, target.Id.GetLowByte(), target.Id.GetHighByte(),
                                    healthDamage.GetLowByte(), healthDamage.GetHighByte(), this.GetDamageColor(hitInfo.Attributes),
