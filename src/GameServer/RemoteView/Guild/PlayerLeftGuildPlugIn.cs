...
/// </summary>
[PlugIn]
[Display(Name = "PlayerLeftGuildPlugIn", Description = "The default implementation of the IPlayerLeftGuildPlugIn which is forwarding everything to the game client with specific data packets.")]
