...
/// </summary>
[PlugIn]
[Display(Name = nameof(ShowGuildWarDeclaredPlugIn), Description = "The default implementation of the IShowGuildWarDeclaredPlugIn which is forwarding everything to the game client with specific data packets.")]
