...
/// </summary>
[PlugIn]
[Display(Name = "GuildJoinResponsePlugIn", Description = "The default implementation of the IGuildJoinResponsePlugIn which is forwarding everything to the game client with specific data packets.")]
