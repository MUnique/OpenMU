...
/// </summary>
[PlugIn]
[Display(Name = nameof(ShowGuildWarResultPlugIn), Description = "The default implementation of the IShowGuildWarResultPlugIn which is forwarding everything to the game client with specific data packets.")]
