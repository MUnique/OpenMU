...
namespace MUnique.OpenMU.GameServer.RemoteView.Guild
{
    ...
    public class ShowGuildWarResultPlugIn: IShowGuildWarResultPlugIn
    {
        ...
        public ShowGuildWarResultPlugIn(RemotePlayer player) => this.player = player;

        /// <inheritdoc/>
        public void ShowResult(string hostileGuildName, GuildWarResult result)
        {
            this.player.Connection?.SendGuildWarEnded(result.Convert(), hostileGuildName);
        }
    }
}