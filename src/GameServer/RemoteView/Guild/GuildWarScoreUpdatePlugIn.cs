...
/// </summary>
[PlugIn]
[Display(Name = nameof(IGuildWarScoreUpdatePlugIn), Description = "The default implementation of the IGuildWarScoreUpdatePlugIn which is forwarding everything to the game client with specific data packets.")]
