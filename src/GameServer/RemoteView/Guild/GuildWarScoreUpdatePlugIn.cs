...
namespace MUnique.OpenMU.GameServer.RemoteView.Guild
{
    ...
    public class GuildWarScoreUpdatePlugIn : IGuildWarScoreUpdatePlugIn
    {
        ...
        public GuildWarScoreUpdatePlugIn(RemotePlayer player) => this.player = player;
        ...
        public void UpdateScore()
        {
            ...
            {
                this.player.Connection?.SendGuildWarScoreUpdate(guildWarContext.ThisScore, guildWarContext.EnemyScore);
            }
        }
    }
}