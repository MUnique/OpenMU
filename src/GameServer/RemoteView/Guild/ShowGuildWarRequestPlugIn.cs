...
/// </summary>
[PlugIn]
[Display(Name = nameof(ShowGuildWarRequestPlugIn), Description = "The default implementation of the IShowGuildWarRequestPlugIn which is forwarding everything to the game client with specific data packets.")]
