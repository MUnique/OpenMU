...
/// </summary>
[PlugIn]
[Display(Name = nameof(AssignPlayersToGuildPlugIn), Description = "The default implementation of the IAssignPlayersToGuildPlugIn which is forwarding everything to the game client with specific data packets.")]
