...
/// </summary>
[PlugIn]
[Display(Name = nameof(ShowSkillAnimationPlugIn075), Description = "The default implementation of the IShowSkillAnimationPlugIn which is forwarding everything to the game client with specific data packets.")]
