...
/// </summary>
[PlugIn]
[Display(Name = "ObjectMovedPlugIn 0.75", Description = "The default implementation of the IObjectMovedPlugIn which is forwarding everything to the game client with specific data packets.")]
