...
/// </summary>
[PlugIn]
[Display(Name = "ShowDroppedItemsPlugIn", Description = "The default implementation of the IShowDroppedItemsPlugIn which is forwarding everything to the game client with specific data packets.")]
