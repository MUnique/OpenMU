...
/// </summary>
[PlugIn]
[Display(Name = nameof(ShowAreaSkillAnimationPlugIn075), Description = "The default implementation of the IShowAreaSkillAnimationPlugIn which is forwarding everything to the game client with specific data packets.")]
