...
/// </summary>
[PlugIn]
[Display(Name = "UpdateRotationPlugIn", Description = "The default implementation of the IUpdateRotationPlugIn which is forwarding everything to the game client with specific data packets.")]
