...
/// </summary>
[PlugIn]
[Display(Name = "ShowHitPlugIn", Description = "The default implementation of the IShowHitPlugIn which is forwarding everything to the game client with specific data packets.")]
