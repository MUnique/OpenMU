...
/// </summary>
[PlugIn]
[Display(Name = nameof(RespawnAfterDeathExtendedPlugIn), Description = "The default implementation of the IRespawnAfterDeathPlugIn which is forwarding everything to the game client with specific data packets.")]
