...
/// </summary>
[PlugIn]
[Display(Name = nameof(ShowAnimationPlugIn), Description = "The default implementation of the IShowAnimationPlugIn which is forwarding everything to the game client with specific data packets.")]
