...
/// </summary>
[PlugIn]
[Display(Name = nameof(MapEventStateUpdatePlugIn), Description = "The default implementation of the IMapEventStateUpdatePlugIn which is forwarding everything to the game client with specific data packets.")]
