...
/// </summary>
[PlugIn]
[Display(Name = nameof(ShowMoneyDropPlugIn), Description = "The default implementation of the IShowMoneyDropPlugIn which is forwarding everything to the game client with specific data packets.")]
