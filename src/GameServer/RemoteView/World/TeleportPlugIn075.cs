...
/// </summary>
[PlugIn]
[Display(Name = nameof(TeleportPlugIn075), Description = "The default implementation of the ITeleportPlugIn which is forwarding everything to the game client with specific data packets.")]
