...
namespace MUnique.OpenMU.GameServer.RemoteView
{
    ...
    {
        /// <inheritdoc/>
        public byte[] Serialize(Guild guild, ushort shortId)
        {
            /*
         *  C1 3C 66 00 87 38 00 00 00
         ...
         */
            ...
            result.SetValues<byte>(0xC1, (byte)result.Length, 0x66, shortId.GetHighByte(), shortId.GetLowByte());
