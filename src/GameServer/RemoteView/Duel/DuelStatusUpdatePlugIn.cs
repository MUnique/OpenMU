...
/// </summary>
[PlugIn]
[Display(Name = nameof(DuelStatusUpdatePlugIn), Description = "The default implementation of the IDuelStatusUpdatePlugIn which is forwarding everything to the game client with specific data packets.")]
