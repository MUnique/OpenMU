...
/// </summary>
[PlugIn]
[Display(Name = nameof(ShowDuelRequestResultPlugIn), Description = "The default implementation of the IShowDuelRequestResultPlugIn which is forwarding everything to the game client with specific data packets.")]
