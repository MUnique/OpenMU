...
/// </summary>
[PlugIn]
[Display(Name = nameof(ShowDuelScoreUpdatePlugIn), Description = "The default implementation of the IShowDuelScoreUpdatePlugIn which is forwarding everything to the game client with specific data packets.")]
