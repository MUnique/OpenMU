...
/// </summary>
[PlugIn]
[Display(Name = nameof(DuelSpectatorRemovedPlugIn), Description = "The default implementation of the IDuelSpectatorRemovedPlugIn which is forwarding everything to the game client with specific data packets.")]
