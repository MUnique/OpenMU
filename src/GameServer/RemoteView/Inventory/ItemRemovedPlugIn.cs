...
/// </summary>
[PlugIn]
[Display(Name = nameof(ItemRemovedPlugIn), Description = "The default implementation of the IItemRemovedPlugIn which is forwarding everything to the game client with specific data packets.")]
