...
/// </summary>
[PlugIn]
[Display(Name = "NpcItemBoughtPlugIn", Description = "The default implementation of the INpcItemBoughtPlugIn which is forwarding everything to the game client with specific data packets.")]
