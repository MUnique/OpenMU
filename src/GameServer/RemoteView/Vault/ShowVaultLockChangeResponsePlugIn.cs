...
/// </summary>
[PlugIn]
[Display(Name = nameof(ShowVaultLockChangeResponsePlugIn), Description = "The default implementation of the IShowVaultLockChangeResponse which is forwarding everything to the game client with specific data packets.")]
