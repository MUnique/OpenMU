...
/// </summary>
[PlugIn]
[Display(Name = nameof(DuelChannelQuitRequestHandlerPlugIn), Description = "Handler for duel channel quit request packets (new duel system), which is sent by a spectator.")]
