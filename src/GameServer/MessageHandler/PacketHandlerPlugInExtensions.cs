...
namespace MUnique.OpenMU.GameServer.MessageHandler
{
    ...
    public static class PacketHandlerPlugInExtensions
    {
        ...
        {
            var currentPlugInClient = packetHandler.GetType().GetCustomAttribute<ClientAttribute>()?.Client ?? default;
            var activatedPluginClient = otherPacketHandlerPlugIn.GetType().GetCustomAttribute<ClientAttribute>()?.Client ?? default;
