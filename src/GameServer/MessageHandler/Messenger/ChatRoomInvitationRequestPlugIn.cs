...
/// </summary>
[PlugIn]
[Display(Name = "ChatRoomInvitationRequestPlugIn", Description = "Packet handler which handles chat room invitation requests, where a player invites additional players to an existing chat room.")]
