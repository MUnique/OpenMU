...
namespace MUnique.OpenMU.GameLogic
{
    ...
    public class PlayerState
    {
        ...
        private PlayerState()
        {
            this.tradeButtonPressed = new State
            {
                ...
                Id = new Guid("706A9618-1C31-4357-8C1A-0AA71B4E89E9")
            };
            this.tradeOpened = new State
            {
                Name = "Trade Opened",
                PossibleTransitions = new List<State>
                {
                ...
                Id = new Guid("F4367C99-1F11-4D42-9ADF-AD4655F022A0")
            };
            this.tradeButtonPressed.PossibleTransitions.Add(this.tradeOpened);
            TradeRequested = new State
            {
                ...
                Id = new Guid("E15623A1-D125-4327-AE6A-9F36C5744BC0")
            };
            EnteredWorld.PossibleTransitions.Add(TradeRequested);
            this.npcDialogOpened = new State
            {
                ...
                Id = new Guid("B0DFD9AC-009C-496C-A1B9-C8D6C6BFE23F")
            };
            EnteredWorld.PossibleTransitions.Add(this.npcDialogOpened);
            this.partyRequest = new State
            {
                ...
                Id = new Guid("FD96D6EC-88F3-4B0C-ADFB-D5DDF1554C48")
            };
            EnteredWorld.PossibleTransitions.Add(this.partyRequest);
            this.guildRequest = new State
            {
                ...
                Id = new Guid("B8C69D28-4CEF-45CE-9D11-37576A97E116")
            };
        ...
        /// </summary>
        public static State Finished { get; } = new State
        {
            Name = "Finished",
            Id = new Guid("AB24C7C4-4F37-40ED-B874-0F6C7984C471")
        };
        ...
        /// </summary>
        public static State Disconnected { get; } = new State
        {
            Name = "Disconnected",
            PossibleTransitions = new List<State>
            {
        ...
        public static State Dead { get; } = new State
        {
            ...
            Id = new Guid("171CBF68-EE19-4C99-8B89-AA8A51AE9876")
        };

        /// <summary>
        /// Gets the character selection state. When this state is active, the character selection screen is shown.
        /// </summary>
        public static State CharacterSelection { get; } = new State
        {
        ...
        public static State Authenticated { get; } = new State
        {
            ...
            Id = new Guid("4D1D2157-E2BB-48EF-9F19-E1892AC49E84")
        };

        /// <summary>
        /// Gets the login screen state. When this state is active, the login screen is shown to the player.
        /// </summary>
        public static State LoginScreen { get; } = new State
        {
            Name = "Login Screen",
            PossibleTransitions = new List<State>
            {
            ...
            Id = new Guid("C59E7072-306F-47BF-A5A0-1C9DA38143C3")
        };

        /// <summary>
        /// Gets the initial state.
        /// </summary>
        public static State Initial { get; } = new State
        {
            Name = "Initial State",
            PossibleTransitions = new List<State>
            {
            ...
            Id = new Guid("D93BC463-810F-46B9-A9F3-8592A055705D")
        };

        /// <summary>
        /// Gets the changing map state.
        /// </summary>
        public static State ChangingMap { get; } = new State
        {
            Name = "Changing Map",
            PossibleTransitions = new List<State>
            {
            ...
            Id = new Guid("FF660582-460C-4B69-9D99-F5EB156E83B9")
        };
