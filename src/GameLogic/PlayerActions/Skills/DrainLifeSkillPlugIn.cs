...
/// </summary>
[PlugIn]
[Display(Name = nameof(DrainLifeSkillPlugIn), Description = "Handles the drain life skill of the summoner class. Additionally to the attacked target, it regains life for damage dealt.")]
