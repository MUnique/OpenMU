...
public interface IChangeTerrainAttributesViewPlugin : IViewPlugIn
{
    ...
    void ChangeAttributes(bool type, TerrainAttributeType attribute, bool setAttribute, IReadOnlyCollection<(byte StartX, byte StartY, byte EndX, byte EndY)> areas);
}