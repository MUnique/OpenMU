...
public class ExtendedTypeContext : Microsoft.EntityFrameworkCore.DbContext
{
    ...
    protected override void OnModelCreating(Microsoft.EntityFrameworkCore.ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Ignore<MUnique.OpenMU.DataModel.Configuration.BuffRequest>();
        ...
        modelBuilder.Entity<BuffRequest>().HasOne(entity => entity.RawMagicEffectDefinition).WithOne().OnDelete(DeleteBehavior.Cascade);
        ...
        modelBuilder.Entity<GameConfiguration>().HasMany(entity => entity.RawGlobalAttributeCombinations).WithOne().OnDelete(DeleteBehavior.Cascade);
        ...
        modelBuilder.Entity<MonsterDefinition>().HasMany(entity => entity.RawBuffRequests).WithOne().OnDelete(DeleteBehavior.Cascade);
