...
public interface IBackupService
{
    ...
    /// <returns><c>true</c>, if the stream contains a backup archive with restorable data; otherwise, <c>false</c>.</returns>
    bool ContainsRestorableData(Stream inputStream);
