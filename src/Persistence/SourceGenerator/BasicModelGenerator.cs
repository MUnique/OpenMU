...
namespace MUnique.OpenMU.Persistence.SourceGenerator
{
    ...
    /// </summary>
    [Generator]
    public class BasicModelGenerator : ModelGeneratorBase, ISourceGenerator
    {
        /// <inheritdoc />
...
{{
    ...
    {{
        ...
        {
            if (!type.GetConstructors().Any(c => c.IsPublic && c.GetParameters().Length > 0) || type.GetConstructors().All(c => c.GetParameters().Length != 0))
            {
                return string.Empty;
            }
