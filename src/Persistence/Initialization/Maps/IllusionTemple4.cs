// <copyright file="IllusionTemple4.cs" company="MUnique">
...
namespace MUnique.OpenMU.Persistence.Initialization.Maps
{
    ...
    /// <summary>
    /// Initialization for the Illusion Temple 4.
    /// </summary>
    internal class IllusionTemple4 : BaseMapInitializer
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IllusionTemple4"/> class.
        /// </summary>
        /// <param name="context">The context.</param>
        /// <param name="gameConfiguration">The game configuration.</param>
        public IllusionTemple4(IContext context, GameConfiguration gameConfiguration)
            : base(context, gameConfiguration)
        {
        }

        /// <inheritdoc/>
        protected override byte MapNumber => 48;

        /// <inheritdoc/>
        protected override string MapName => "Illusion Temple 4";
