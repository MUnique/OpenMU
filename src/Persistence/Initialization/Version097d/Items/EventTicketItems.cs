...
/// <summary>
/// Initializer for event ticket items which exist in 0.97d.
/// </summary>
internal class EventTicketItems : InitializerBase
{
    ...
    public override void Initialize()
    {
        ...
        this.CreateEventItem(18, 13, 2, 2, "Invisibility Cloak", false, 6);
        this.CreateEventItem(19, 13, 1, 2, "Weapon of Archangel", false);

        // Devil Square (levels 1-4)
    ...
    private void CreateEventItem(byte number, byte group, byte width, byte height, string name, bool dropsFromMonsters, byte maxItemLevel = 0, params byte[] dropLevels)
    {
