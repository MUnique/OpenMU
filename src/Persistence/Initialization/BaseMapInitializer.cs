...
namespace MUnique.OpenMU.Persistence.Initialization
{
    ...
    internal abstract class BaseMapInitializer : IMapInitializer
    {
        ...
        private Dictionary<short, MonsterDefinition>? npcDictionary;
        ...
        /// </summary>
        protected Dictionary<short, MonsterDefinition> NpcDictionary => this.npcDictionary ??= this.GameConfiguration.Monsters.ToDictionary(npc => npc.Number, npc => npc);
