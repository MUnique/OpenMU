...
public class BerserkerEffectInitializer : InitializerBase
{
    ...
    public override void Initialize()
    {
        ...
        durationPerEnergy.InputAttribute = Stats.BaseEnergy.GetPersistent(this.GameConfiguration); // BaseEnergy and not TotalEnergy
        ...
        healthPowerUpDefinition.TargetAttribute = Stats.BerserkerHealthMultiplierFactor.GetPersistent(this.GameConfiguration);
