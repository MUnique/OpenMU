...
namespace MUnique.OpenMU.Persistence.Initialization.VersionSeasonSix
{
    ...
    internal class SkillsInitializer : SkillsInitializerBase
    {
        ...
        public override void Initialize()
        {
            ...
            this.CreateSkill(SkillNumber.Cometfall, "Cometfall", CharacterClasses.AllMagicians, DamageType.Wizardry, 70, 3, manaConsumption: 150, energyRequirement: 436, elementalModifier: ElementalType.Lightning);
            ...
            this.CreateSkill(SkillNumber.Nova, "Nova", CharacterClasses.SoulMasterAndGrandMaster, DamageType.Wizardry, distance: 6, abilityConsumption: 45, manaConsumption: 180, levelRequirement: 100, energyRequirement: 1052, elementalModifier: ElementalType.Fire, skillType: SkillType.Other);
