...
internal class BloodCastle7 : BloodCastleBase
{
    ...
    /// </summary>
    internal const byte Number = 17;

    /// <summary>
    /// The MapDiscriminator of the Map.
    /// </summary>
    internal const byte Discriminator = 7;
    ...
    protected override IEnumerable<MonsterSpawnArea> CreateMonsterSpawns()
    {
        ...
        yield return this.CreateMonsterSpawn(this.NpcDictionary[141], 014, 069, Direction.Undefined, SpawnTrigger.AutomaticDuringEvent); // Giant Ogre 7
