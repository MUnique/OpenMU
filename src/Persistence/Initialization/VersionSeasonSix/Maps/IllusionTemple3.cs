// <copyright file="IllusionTemple3.cs" company="MUnique">
...
/// <summary>
/// Initialization for the Illusion Temple 3.
/// </summary>
internal class IllusionTemple3 : BaseMapInitializer
{
    /// <summary>
    /// The Number of the Map.
    /// </summary>
    internal const byte Number = 47;

    /// <summary>
    /// The Name of the Map.
    /// </summary>
    internal const string Name = "Illusion Temple 3";

    /// <summary>
    /// Initializes a new instance of the <see cref="IllusionTemple3"/> class.
    /// </summary>
    /// <param name="context">The context.</param>
    /// <param name="gameConfiguration">The game configuration.</param>
    public IllusionTemple3(IContext context, GameConfiguration gameConfiguration)
    ...
    protected override IEnumerable<MonsterSpawnArea> CreateMonsterSpawns()
    {
        ...
        // Roaming "Illusion Sorc. Spirit" monsters (392-394) - killing them grants skill points for the
        // event's special skills.
        for (var i = 0; i < SorcererSpiritPositions.Length; i++)
        {
            var (x, y) = SorcererSpiritPositions[i];
            yield return this.CreateMonsterSpawn((short)(120 + i), this.NpcDictionary[(short)(392 + (i % 3))], x, y, Direction.Undefined, SpawnTrigger.AutomaticDuringEvent);
        }
    }
