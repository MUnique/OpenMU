...
internal class BloodCastle6 : BloodCastleBase
{
    ...
    /// </summary>
    internal const byte Number = 16;

    /// <summary>
    /// The MapDiscriminator of the Map.
    /// </summary>
    internal const byte Discriminator = 6;
    ...
    protected override IEnumerable<MonsterSpawnArea> CreateMonsterSpawns()
    {
        ...
        yield return this.CreateMonsterSpawn(this.NpcDictionary[128], 014, 069, Direction.Undefined, SpawnTrigger.AutomaticDuringEvent); // Giant Ogre 6
