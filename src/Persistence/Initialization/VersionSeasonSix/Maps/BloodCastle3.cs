...
internal class BloodCastle3 : BloodCastleBase
{
    ...
    /// </summary>
    internal const byte Number = 13;

    /// <summary>
    /// The MapDiscriminator of the Map.
    /// </summary>
    internal const byte Discriminator = 3;
    ...
    protected override IEnumerable<MonsterSpawnArea> CreateMonsterSpawns()
    {
        ...
        yield return this.CreateMonsterSpawn(this.NpcDictionary[099], 014, 069, Direction.Undefined, SpawnTrigger.AutomaticDuringEvent); // Giant Ogre 3
