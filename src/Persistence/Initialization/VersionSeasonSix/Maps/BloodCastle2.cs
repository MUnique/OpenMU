...
internal class BloodCastle2 : BloodCastleBase
{
    ...
    /// </summary>
    internal const byte Number = 12;

    /// <summary>
    /// The MapDiscriminator of the Map.
    /// </summary>
    internal const byte Discriminator = 2;
    ...
    protected override IEnumerable<MonsterSpawnArea> CreateMonsterSpawns()
    {
        ...
        yield return this.CreateMonsterSpawn(this.NpcDictionary[093], 014, 069, Direction.Undefined, SpawnTrigger.AutomaticDuringEvent); // Giant Ogre 2
