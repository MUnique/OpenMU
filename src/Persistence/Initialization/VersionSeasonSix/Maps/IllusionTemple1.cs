// <copyright file="IllusionTemple1.cs" company="MUnique">
...
internal class IllusionTemple1 : BaseMapInitializer
{
    ...
    protected override IEnumerable<MonsterSpawnArea> CreateMonsterSpawns()
    {
        ...
        // Roaming "Illusion Sorc. Spirit" monsters (386-388) - killing them grants skill points for the
        // event's special skills.
        for (var i = 0; i < SorcererSpiritPositions.Length; i++)
        {
            var (x, y) = SorcererSpiritPositions[i];
            yield return this.CreateMonsterSpawn((short)(120 + i), this.NpcDictionary[(short)(386 + (i % 3))], x, y, Direction.Undefined, SpawnTrigger.AutomaticDuringEvent);
        }
    }
