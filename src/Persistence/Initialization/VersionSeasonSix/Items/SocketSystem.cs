...
public class SocketSystem : InitializerBase
{
    ...
    private ItemOptionDefinition CreateIceOptions()
    {
        ...
        definition.PossibleOptions.Add(this.CreateSocketOption(4, SocketSubOptionType.Ice, Stats.WeaponDurationIncrease, AggregateType.Multiplicate, 1.30f, 1.32f, 1.34f, 1.36f, 1.38f));
        return definition;
    }
