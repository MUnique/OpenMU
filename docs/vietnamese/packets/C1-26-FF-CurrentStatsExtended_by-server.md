# C1 26 FF - CurrentStatsExtended (server gửi)

## Được gửi khi nào

Định kỳ hoặc nếu các chỉ số hiện tại, như máu, lá chắn, năng lượng hoặc tốc độ tấn công thay đổi ở phía máy chủ, ví dụ: bằng lượt truy cập.
...
| 20 | 2 | ShortLittleEndian |  | Tốc độ tấn công |
| 22 | 2 | ShortLittleEndian |  | Phép thuậtTốc độ |