# C2 F6 1B - QuestStateExtended (server gửi)

## Được gửi khi nào

Sau khi ứng dụng khách trò chơi yêu cầu, người chơi mở menu nhiệm vụ và nhấp vào nhiệm vụ.
...
| 1 | 2 | Short | 272 | Tiêu đề gói - chiều dài của gói |
| 3 | 1 | Byte | 0xF6 | Tiêu đề gói - mã định danh loại gói |
| 4 | 1 | Byte | 0x1B | Tiêu đề gói - mã định danh loại gói phụ |
| 5 | 1 | Byte |  | Tình trạngĐếm |
| 6 | 1 | Byte |  | Số phần thưởng |
| 7 | 1 | Byte |  | Đếm phần thưởng ngẫu nhiên |
| 8 | 2 | ShortLittleEndian |  | Số nhiệm vụ |
| 10 | 2 | ShortLittleEndian |  | Nhóm nhiệm vụ |
| 12 | QuestConditionExtended.Length * ConditionCount | Array of QuestConditionExtended |  | Điều kiện |
| 152 | QuestRewardExtended.Length * RewardCount | Array of QuestRewardExtended |  | Phần thưởng |

### Cấu trúc QuestConditionExtended
...
| 2 | 2 | ShortLittleEndian |  | Id yêu cầu; Tùy thuộc vào loại điều kiện, trường này chứa mã định danh của thứ được yêu cầu, ví dụ: Số Quái vật, Id Vật phẩm, Cấp độ. |
| 4 | 4 | IntegerLittleEndian |  | Số lượng bắt buộc |
| 8 | 4 | IntegerLittleEndian |  | Số lượng hiện tại |
| 12 | 15 | Binary |  | Dữ liệu bắt buộc; Nếu loại điều kiện là 'Mục' thì trường này chứa dữ liệu mục, ngoại trừ id mục. Id mục có thể được tìm thấy trong trường RequirementId. |
...
|-------|--------|-----------|-------|-------------|
| 0 | 1 | RewardType |  | Type |
| 2 | 2 | ShortLittleEndian |  | Id phần thưởng; Tùy thuộc vào loại điều kiện, trường này chứa mã định danh của thứ được yêu cầu, ví dụ: Số Quái vật, Id Vật phẩm, Cấp độ. |
| 4 | 4 | IntegerLittleEndian |  | Số phần thưởng |
| 8 | 15 | Binary |  | Phần thưởngItemData; Nếu loại phần thưởng là 'Vật phẩm' thì trường này chứa dữ liệu vật phẩm của nó. |
