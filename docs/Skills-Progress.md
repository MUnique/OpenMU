...
| 225    | Pollution                     | ?               |
| 230    | Lightning Shock               | ?               |
| 232    | Strike of Destruction         | works           |
...
| 304    | Poison Resistance Inc         | works           |
| 305    | Durability Reduction (2)      | works           |
| 306    | SD Recovery Speed Inc         | not implemented |
| 307    | Automatic HP Rec Inc          | works           |
| 308    | Lightning Resistance Inc      | works           |
| 309    | Defense Increase              | works           |
| 310    | Automatic AG Rec Inc          | works           |
| 311    | Ice Resistance Increase       | works           |
| 312    | Durability Reduction (3)      | works           |
| 313    | Defense Success Rate Inc      | works           |
| 325    | Attack Succ Rate Inc          | works           |
| 326    | Cyclone Strengthener          | works           |
| 327    | Slash Strengthener            | works           |
| 328    | Falling Slash Streng          | works           |
| 329    | Lunge Strengthener            | works           |
| 330    | Twisting Slash Streng         | works           |
| 331    | Rageful Blow Streng           | works           |
| 332    | Twisting Slash Mastery        | works           |
| 333    | Rageful Blow Mastery          | works           |
| 334    | Maximum Life Increase         | works           |
| 335    | Weapon Mastery                | works           |
| 336    | Death Stab Strengthener       | works           |
| 337    | Strike of Destr Str           | works           |
| 338    | Maximum Mana Increase         | works           |
| 347    | PvP Attack Rate               | works           |
| 348    | Two-handed Sword Stren        | works           |
| 349    | One-handed Sword Stren        | works           |
| 350    | Mace Strengthener             | works           |
...
| 360    | Swell Life Proficiency        | works           |
| 361    | Minimum Attack Power Inc      | works           |
| 362    | Monster Attack Mana Inc       | works           |
| 378    | Flame Strengthener            | works           |
| 379    | Lightning Strengthener        | works           |
| 380    | Expansion of Wiz Streng       | not implemented |
| 381    | Inferno Strengthener          | works           |
| 382    | Blast Strengthener            | works           |
| 383    | Expansion of Wiz Mas          | not implemented |
| 384    | Poison Strengthener           | works           |
| 385    | Evil Spirit Streng            | works           |
| 386    | Magic Mastery                 | works           |
| 387    | Decay Strengthener            | works           |
| 388    | Hellfire Strengthener         | works           |
| 389    | Ice Strengthener              | works           |
| 397    | One-handed Staff Stren        | works           |
| 398    | Two-handed Staff Stren        | works           |
| 399    | Shield Strengthener           | works           |
| 400    | One-handed Staff Mast         | works           |
| 401    | Two-handed Staff Mast         | works           |
| 402    | Shield Mastery                | works           |
| 403    | Soul Barrier Strength         | works           |
| 404    | Soul Barrier Proficie         | works           |
...
| 423    | Defense Increase Mastery      | works           |
| 424    | Ice Arrow Strengthener        | works           |
| 435    | Bow Strengthener              | works           |
| 436    | Crossbow Strengthener         | works           |
| 437    | Shield Strengthener           | works           |
...
| 479    | Cyclone Strengthener          | works           |
| 480    | Lightning Strengthener        | works           |
| 481    | Twisting Slash Stren          | works           |
| 482    | Power Slash Streng            | works           |
| 483    | Flame Strengthener            | works           |
| 484    | Blast Strengthener            | works           |
| 485    | Weapon Mastery                | works           |
| 486    | Inferno Strengthener          | works           |
| 487    | Evil Spirit Strengthen        | works           |
| 488    | Magic Mastery                 | works           |
| 489    | Ice Strengthener              | works           |
